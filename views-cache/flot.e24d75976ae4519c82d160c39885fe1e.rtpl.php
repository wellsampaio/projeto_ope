...
<script>
  $(function () {
    ...
    var bar_data = {
      data: [["Em Aberto", <?php echo htmlspecialchars( $quantOrdersEmAberto, ENT_COMPAT, 'UTF-8', FALSE ); ?>], ["Aguardando Pagamento", <?php echo htmlspecialchars( $quantOrdersAgPagamento, ENT_COMPAT, 'UTF-8', FALSE ); ?>], ["Pago", <?php echo htmlspecialchars( $quantOrdersPago, ENT_COMPAT, 'UTF-8', FALSE ); ?>],["Entregue", <?php echo htmlspecialchars( $quantOrdersEntregue, ENT_COMPAT, 'UTF-8', FALSE ); ?>]],
      color: "#3c8dbc"
    };
