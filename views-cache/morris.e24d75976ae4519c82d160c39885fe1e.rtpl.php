...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Graficos Pedidos
        <small>Anual e Mensal</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="/admin"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="#">Graficos Pedidos</a></li>
      </ol>
    </section>
      ...
      <div class="row">
        <div class="col-md-6">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Quantidade de Pedidos Pagos Mensal 2019</h3>
          ...
          <div class="box box-danger">
            <div class="box-header with-border">
              <h3 class="box-title">Pedidos Total Por Status</h3>
        ...
        <div class="col-md-6">
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Valor Total dos Pedidos Anual 2019 - 2022</h3>
...
<script>
  $(function () {
    ...
    var line = new Morris.Line({
      ...
      resize: true,
      data: [
        {y: '2019', item1: <?php echo htmlspecialchars( $somaVlTotalPago2019, ENT_COMPAT, 'UTF-8', FALSE ); ?>},
        {y: '2020', item1: 0},
        {y: '2021', item1: 0},
        {y: '2022', item1: 0}
      ],
    ...
    var donut = new Morris.Donut({
      ...
      data: [
        {label: "Aguardando Pagamento", value: <?php echo htmlspecialchars( $quantOrdersAgPagamento, ENT_COMPAT, 'UTF-8', FALSE ); ?>},
        {label: "Cancelados", value: <?php echo htmlspecialchars( $quantOrdersCancelados, ENT_COMPAT, 'UTF-8', FALSE ); ?>},
        {label: "Pagos", value: <?php echo htmlspecialchars( $quantOrdersPago, ENT_COMPAT, 'UTF-8', FALSE ); ?>}
      ],
      hideHover: 'auto'
    });
    //BAR CHART
    var bar = new Morris.Bar({
      ...
      resize: true,
      data: [
        {y: 'Janeiro', a: <?php echo htmlspecialchars( $quantOrdersPagoJan, ENT_COMPAT, 'UTF-8', FALSE ); ?>},
        {y: 'Fevereiro', a: <?php echo htmlspecialchars( $quantOrdersPagoFev, ENT_COMPAT, 'UTF-8', FALSE ); ?>},
        {y: 'Março', a: <?php echo htmlspecialchars( $quantOrdersPagoMar, ENT_COMPAT, 'UTF-8', FALSE ); ?>},
        {y: 'Abril', a: <?php echo htmlspecialchars( $quantOrdersPagoAbril, ENT_COMPAT, 'UTF-8', FALSE ); ?>},
        {y: 'Maio', a: <?php echo htmlspecialchars( $quantOrdersPagoMaio, ENT_COMPAT, 'UTF-8', FALSE ); ?>},
        {y: 'Junho', a: <?php echo htmlspecialchars( $quantOrdersPagoJun, ENT_COMPAT, 'UTF-8', FALSE ); ?>},
        {y: 'Julho', a: <?php echo htmlspecialchars( $quantOrdersPagoJul, ENT_COMPAT, 'UTF-8', FALSE ); ?>},
        {y: 'Agosto', a: <?php echo htmlspecialchars( $quantOrdersPagoAgo, ENT_COMPAT, 'UTF-8', FALSE ); ?>},
        {y: 'Setembro', a: <?php echo htmlspecialchars( $quantOrdersPagoSet, ENT_COMPAT, 'UTF-8', FALSE ); ?>},
        {y: 'Outubro', a: <?php echo htmlspecialchars( $quantOrdersPagoOut, ENT_COMPAT, 'UTF-8', FALSE ); ?>},
        {y: 'Novembro', a: <?php echo htmlspecialchars( $quantOrdersPagoNov, ENT_COMPAT, 'UTF-8', FALSE ); ?>},
        {y: 'Dezembro', a: <?php echo htmlspecialchars( $quantOrdersPagoDez, ENT_COMPAT, 'UTF-8', FALSE ); ?>}
