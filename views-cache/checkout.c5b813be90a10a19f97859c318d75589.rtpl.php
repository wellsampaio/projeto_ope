								...
								<div class="col-md-12">
									...
									<div class="woocommerce-billing-fields">
										...
										<p id="billing_state_field" class="form-row form-row-first address-field validate-state" data-o_class="form-row form-row-first address-field validate-state">
											...
											<input type="text" id="billing_state" name="desdelivery" placeholder="Data de entrega" value="<?php echo htmlspecialchars( $address["desdelivery"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" class="input-text ">
										</p>
										<div class="clear"></div>
										...
										<div id="order_review" style="position: relative;">
											...
											<p id="billing_state_field" class="form-row form-row-first address-field validate-state" data-o_class="form-row form-row-first address-field validate-state">
											<input type="radio" id="method-paypal" checked="checked" name="payment-method" value="2" style="float:left; margin: 30px;">
