...
<div class="single-product-area">
     <h2 style="color: #ffffff; text-align: center; font-size: 50px;">Minha Conta</h2><br>
    ...
    <div class="container">
        <div class="row">                
            ...
            <div class="col-md-9">
                ...
                <h3 id="order_review_heading" style="margin-top:30px; color: #ffffff;">Detalhes do Pedido N°<?php echo htmlspecialchars( $order["idorder"], ENT_COMPAT, 'UTF-8', FALSE ); ?></h3>
                <div id="order_review" style="position: relative;">
                    <table class="shop_table">
                        ...
                        <tbody>
                            ...
                            <tr class="cart_item">
                                <td class="product-name" style="color: #fff">
                                ...
                                <td class="product-total" style="color: #fff">
                        ...
                        <tfoot>
                            <tr class="cart-subtotal">
                                <th>Subtotal</th>
                                <td style="color: #fff"><span class="amount">R$ <?php echo htmlspecialchars( $cart["vlsubtotal"], ENT_COMPAT, 'UTF-8', FALSE ); ?></span>
                                </td>
                            </tr>
                            <tr class="shipping">
                                <th>Frete</th>
