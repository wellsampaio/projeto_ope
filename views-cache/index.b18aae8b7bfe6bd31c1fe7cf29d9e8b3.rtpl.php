        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              <span class="info-box-text">Total dos Pedidos Pagos</span>
              <span class="info-box-number">R$ <?php echo htmlspecialchars( $somaVlTotalPago, ENT_COMPAT, 'UTF-8', FALSE ); ?></span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              ...
              <span class="info-box-number">R$ <?php echo htmlspecialchars( $somaVlTotal, ENT_COMPAT, 'UTF-8', FALSE ); ?></span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
