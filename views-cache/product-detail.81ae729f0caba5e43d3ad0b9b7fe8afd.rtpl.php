                        ...
                        <div class="col-sm-6">
                            <div class="product-inner">
                                ...
                                <form action="/cart/<?php echo htmlspecialchars( $product["idproduct"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/add" class="cart">
                                    <div class="quantity">
                                        <input type="number" size="4" class="input-text qty text" title="Qty" value="" name="qtd" min="1" step="1">
                                    </div>
                                ...
                                <div role="tabpanel">
                                    ...
                                    <div class="tab-content">
                                        <div role="tabpanel" class="tab-pane fade in active" id="home">
                                            ...
                                            <p><?php echo htmlspecialchars( $product["vlfilling"], ENT_COMPAT, 'UTF-8', FALSE ); ?></p>
                                        </div>
