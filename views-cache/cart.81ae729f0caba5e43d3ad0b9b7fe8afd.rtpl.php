<?php if(!class_exists('Rain\Tpl')){exit;}?><div class="single-product-area">
    <h2 style="text-align: center; font-size: 50px;">Carrinho de Compras</h2><br>
                        ...
                        <form action="/checkout" onsubmit="return valida_form(this)">
                                    ...
                                    <tr class="cart_item">
                                        ...
                                        <td class="product-quantity">
                                            <div class="quantity buttons_added">
                                                ...
                                                <input type="number" size="4" class="input-text qty text" title="Qty" value="<?php echo htmlspecialchars( $value1["nrqtd"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" min="0" step="1" disabled="disabled">
                            ...
                            <div class="cart-collaterals">
                                ...
                                <div class="cart_totals ">
                                    ...
                                    <h2 style="color: #000">Resumo da Compra</h2>
